...
router.get('/',ensureAuthenticated,(req,resp)=>{
    ...
    ChannelModel.find({},(err,channel_list)=>{
            ...
            resp.render('index',{channels:channel_list,name:req.user.name,usernames})
    })
})
//for new channel
...
router.get('/:id',ensureAuthenticated,(req,resp)=>{
        ...
        .exec((err,channel_list)=>{
            ...
            console.log(channel)
            resp.render('channelDetails', {channel,channels:channel_list,name:req.user.name,usernames})
        })
    })
})
